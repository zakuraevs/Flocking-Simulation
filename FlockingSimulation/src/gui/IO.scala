...
//Object responsible for handling laoding and saving of files
object IO {
  ...
  def loadFile(): Unit = {
        ...
        try {    
          ...
          if(chooser.showOpenDialog(null)==FileChooser.Result.Approve) {
            ...
            //Changing labels to laoded values
    ...
    def saveFile(): Unit = {
      ...
      if(chooser.showSaveDialog(null) == FileChooser.Result.Approve) { 
        ...
        for(i <- 0 to zippedCoords.size-1) { //(coord <- zippedCoords) {
