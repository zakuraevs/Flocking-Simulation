...
import scala.math._
import java.awt._
import gui.FlockSimulationApp._
import logic._
import logic.Parameters._
  
  
//Object responsible for the menu bar and its contents
object MenuBar {
    ...
    //An object that stores methods for the File submenu
    object FileMenu {
      ...
      def reset(): Unit = {
        ...
        if(!FlockSimulationApp.controlsSuperPanel.obstacleControlsHidden) {
          ...
          //FlockSimulationApp.controlsSuperPanel.seeAheadLabel
          //FlockSimulationApp.controlsSuperPanel.avoidanceLabel
        }
      }
    }
    ...
    //An object that stores methods for the Help menu
    object HelpMenu {
      ...
      def howToUse() = {
        val helpWindow =   new scala.swing.Frame() {
          ...
          val text = new scala.swing.TextArea {text = helpText}
      ...
      def loadingFormat() = {
        val formatWindow =   new scala.swing.Frame() {
          ...
          val text = new scala.swing.TextArea {text = formatText}
          val container = new BoxPanel(Orientation.Vertical) 
          container.contents += text
          contents = container
        }
    ...
    //An object that stores methods for the Presets menu
    //Contains presets
    object PresetsMenu {
    ...
    //An object that stores methods for the Themes menu
